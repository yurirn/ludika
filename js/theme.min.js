! function(e) {
    e(document).on("ready", function() {
        e("html"), new Image, Math.max(document.documentElement.clientWidth, window.innerWidth || 0);
        e(".lazy").lazyload(), e(".botao-simular-frete, #shippingSimulatorButton").on("click", function() {
            e(".shipping-result").html(""),
                function t(n, s) {
                    null == document.querySelector(n) ? setTimeout(function() {
                        t(n, s)
                    }, s) : e(".shipping-result").html(e(".page-simula-frete"))
                    e("#modal").modal('hide')
        ...
        }), e(".caixa-cupom").length && e(".caixa-cupom").parents("tr").addClass("cupom-wrapper"), e("#calculoFrete").length && e("#calculoFrete").parents("tr").addClass("frete-wrapper"), e(".open-filters").on("click", function() {
            e(".filters-list").slideToggle()
        })
    });
    var t = e(".floating");
    e(window).on("scroll", function() {
        e(window).scrollTop() > 212 ? t.addClass("fixed") : t.removeClass("fixed")
    })
}(jQuery),
function() {
    var e = document.getElementsByClassName("trigger-menu")[0],
        t = document.getElementsByTagName("html")[0],
        n = document.getElementsByClassName("menu-mobile-backdrop")[0];
    e.addEventListener("touchend", function() {
        t.classList.add("menu-open")
    }), t.addEventListener("touchend", function(e) {
        e.target == n && (this.className = this.className.replace(new RegExp("(^|\\b)" + "menu-open".split(" ").join("|") + "(\\b|$)", "gi"), " "))
    })
}();